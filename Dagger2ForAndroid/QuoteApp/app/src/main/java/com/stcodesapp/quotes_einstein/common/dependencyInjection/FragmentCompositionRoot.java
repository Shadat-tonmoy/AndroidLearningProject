...
public class FragmentCompositionRoot {

    private CompositionRoot compositionRoot;
    private FragmentActivity activity;
    private FragmentManager fragmentManager;

    public FragmentCompositionRoot(CompositionRoot compositionRoot, FragmentActivity activity, FragmentManager fragmentManager) {
